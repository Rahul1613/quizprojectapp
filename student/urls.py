...
urlpatterns = [
    ...
    path('student-notifications/', views.student_notifications_view, name='student-notifications'),
    path('upload-csv/', views.upload_csv_view, name='upload-csv'),
    path('exam-report/<int:course_id>', views.generate_exam_report, name='exam-report'),
]