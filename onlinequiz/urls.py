...
from quiz.advanced_chatbot import advanced_chatbot_message
...
urlpatterns = [
    ...
    path('admin-quiz-details', views.admin_quiz_details_view, name='admin-quiz-details'),
    path('chatbot/message', advanced_chatbot_message, name='chatbot_message'),
]
